"""
Plot MAE vs Pearson coefficient for Labsensor experiment results.

Usage:
    python plot_labsensor_comparison.py --dir exp_results/Labsensor --out plots/labsensor_comparison.png
...
def gather_results(directory, aggregate_out=None):
    ...
    if aggregate_out and records:
        ...
        print(f"Saved aggregated CSV to {aggregate_out} ({len(agg_df)} rows)")
    else:
